...
class Main extends Proxy
{
    ...
    public function __construct($vars)
    {
        ...
        if (!file_exists($this->madeline_path) && $this->real_token !== '') {
            ...
            $madeline = new \danog\MadelineProto\API(['logger' => ['logger' => 1],'pwr' => ['pwr' => true, 'db_token' => $this->db_token, 'strict' => true],'app_info' => ['api_id' => 6, 'api_hash' => 'eb06d4abfb49dc3eeb1aeb98ae0f581e'],'connection_settings' => ['all' => ['test_mode' => $this->deep]],'updates' => ['handle_updates' => false, 'handle_old_updates' => false]]);
